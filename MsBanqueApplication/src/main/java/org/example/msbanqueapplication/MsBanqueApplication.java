package org.example.msbanqueapplication;
import org.example.msbanqueapplication.entities.Compte;
import org.example.msbanqueapplication.entities.TypeCompte;
...
public class MsBanqueApplication {
	...
	CommandLineRunner start(CompteRepository compteRepository) {
		return args -> {
			...
			compteRepository.save(new Compte(null, Math.random() * 9000, new Date(), TypeCompte.COURNT));
			compteRepository.save(new Compte(null, Math.random() * 9000, new Date(), TypeCompte.EPARGNE));
